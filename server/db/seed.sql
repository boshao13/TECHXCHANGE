...
INSERT INTO users (`email`, `name`, `password`, `thumbnail_url`, `description`, `street`, `zip_code`)
VALUES ('sally@gmail.com', 'sally', 'pass321', 'image.jpeg', 'i like trading laptops', '20 street avenue', 95747);

INSERT INTO users (`email`, `name`, `password`, `thumbnail_url`, `description`, `street`, `zip_code`)
VALUES ('chris@gmail.com', 'chris', 'pass345', 'image.jpeg', 'i trade stuff', '10 street boulevard', 94010);

INSERT INTO devices (`user_id`, `name`, `thumbnail_url`, `description`, `condition`)
VALUES (1, 'iPhone 7', 'image1.jpeg', 'minor scratches.', 'great');
